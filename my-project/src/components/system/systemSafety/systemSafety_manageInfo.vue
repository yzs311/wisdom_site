<template>
    <div id="systemSafety_manageInfo">
        <div class="content-box">
            <div class="tab">
                <span @click="$router.push('/systemSafety_manage')">
                ...
                <el-table :data="allTableData" stripe border>
                    ...
                    <el-table-column prop="status" label="状态" width="169">
                        <template slot-scope="scope">
                            ...
                            <div style="line-height:0.7rem;color:#ff7a81" v-else>
                                {{scope.row.status}}
                            </div>
                        </template>
                    </el-table-column>
            ...
            <div class="searchBox">
                ...
                <ul>
                    ...
                    <li>
                        整改日期：
                        <el-date-picker v-model="value2" type="date" placeholder="所有"></el-date-picker>
                    </li>
                    <li>
                        检查区域：
                        <el-input v-model="district" placeholder="所有"></el-input>
                    </li>
                    <li>
                        复查日期：
                        <el-date-picker v-model="value3" type="date" placeholder="所有"></el-date-picker>
                    </li>

                    <li>
                        整改期限：
                        <el-date-picker v-model="value4" type="date" placeholder="所有"></el-date-picker>
                    </li>
                    <li>
                        检查类型：
                        <el-input v-model="type" placeholder="所有"></el-input>
                    </li>
                    <li></li>
                    <li></li>
                </ul>
