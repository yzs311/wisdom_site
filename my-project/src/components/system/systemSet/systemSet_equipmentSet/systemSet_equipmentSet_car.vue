    ...
    <div id="systemSet_equipmentSet_car">
        <div class="content-box">
            ...
            <div class="button" v-show="navState">
                <a @click="truckSpaceShow=true" style="right:1.28rem">
                    <i class="icon"></i>
                    场内车位设置
                </a>
                <a @click="dialogClick">
            ...
            <!-- 遮罩层 -->
            <div class="shade-box" v-show="dialogShow || compileShow || personnelShow || truckSpaceShow"></div>
        </div>
    </div>
</template>
