        ...
        <div class="content">
            ...
            <div class="right-main">
                ...
                <div class="home-page" v-show="!alarmShow">
                    ...
                    <!-- 导航栏 -->
                    <div class="nav">
                        <a @click="selectShow=1" :class="selectShow==1?'active':''">地下水位</a>
                        <a @click="selectShow=2" :class="selectShow==2?'active':''">土地位移</a>
                        <a @click="selectShow=3" :class="selectShow==3?'active':''">周边沉降</a>
                        <a @click="selectShow=4" :class="selectShow==4?'active':''">支撑轴力</a>
                    </div>
                    <!-- 地下水位实时数据 -->
                        ...
                        <div class="data-box">
                            ...
                            <div class="top-box">
                                ...
                                <div class="right-box">
                                    <ul>
                                        <li>
                                            <span style="width:2rem;">土地位移(mm)</span>
                                            <span style="width:1rem;">时间</span>
                                            <span style="width:.4rem;">状态</span>
                                        </li>
                                        <li>
                            ...
                            <div class="table-height">
                                <span style="width:33%;">检测点</span>
                                <span style="width:33%;">土地位移(mm)</span>
                                <span style="width:33%;">采集时间</span>
                            </div>
                            <div class="bottom-box">
                                <ul>
